---
title: 'Document all project'
mode: agent
description: Guide an AI agent through a structured process to assess documentation coverage, identify gaps, and create the documentation files
excerpt: 'Guide an AI agent through a structured process to assess documentation coverage, identify gaps, and create the documentation files'
...
This workflow guides AI agents through a systematic approach to analyze documentation coverage, identify gaps, and create the documentation files
...
- All documentation must we written in English

**Documentation Standards:**
- **README.md**: Project overview, installation, basic usage and contribution
- **ARCHITECTURE.md**: System design, components, data flow with mermaid diagrams
...
## 4. Documentation Tasks Implementation Phase

**AI Agent Instructions:**
- Implement each documentation task. to do so:
  - Create the files or update existing ones as specified
  - To create README.md follow the prompt guidelines [here](./create-readme.prompt.md)
  - To create ARCHITECTURE.md follow the prompt guidelines [here](./create-architecture.prompt.md)
  - Modify the codebase to add comments/docstrings where needed
...
- [ ] All files created/updated as per tasks
- [ ] Documentation meets quality standards
- [ ] README.md covers all essential sections
- [ ] ARCHITECTURE.md includes diagrams and component overviews
- [ ] Code comments/docstrings added to all public classes/methods
- [ ] Complex logic adequately explained in comments
- [ ] Installation and contribution instructions are clear and complete
...
**Success Criteria:**
- ✅ README.md and ARCHITECTURE.md created following the prompts indicated
- ✅ The code is documented according to language standards
